<div class="row">
    <div class="col-lg-8 mx-auto">
        <div class="card bg-light">
            ...
            <div class="card-body">
                <form action="<?=URLROOT . "/tasks/edit/" . $data["id"];?>"  method="post">
                    
                    <div class="form-group">
                        <label for="name">ID задачи:</label>
                        <input type="text" name="name" placeholder="Иван Иванович" disabled class="form-control" value="<?=$data["id"]?>">
                    </div>
